...
if __name__ == '__main__':
    ...
    parser.add_argument('-ts', '--test_path',
                        help='the path to the data. it must contains a img folder containing the train image and a '
                             'bboxes folder containing the bounding boxes')
    parser.add_argument('-ed', '--episode_dot', help='number of episodes for dot training', default='500')
    parser.add_argument('-et', '--episode_tod', help='number of episodes for tod training', default='500')
    ...
    parser.add_argument('-gd', '--gamma_dot', help='gamma factor of the discounted rewards', default='0.1')
    parser.add_argument('-gt', '--gamma_tod', help='gamma factor of the discounted rewards', default='0.5')

    parser.add_argument('-epsd', '--epsilon_dot', help='gamma factor of the discounted rewards', default='0.3')
    parser.add_argument('-epst', '--epsilon_tod', help='gamma factor of the discounted rewards', default='0.4')
    ...
    trainer.agent.load("DOT-weights.pt")
